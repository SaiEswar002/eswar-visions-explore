...
import { Briefcase, Award, Users, X, ChevronLeft, ChevronRight, Calendar, Lightbulb } from "lucide-react";
        ...
        <AnimatePresence mode="wait">
          {!selectedExperience ? (
            ...
            >
              ...
              {/* Sub-Experiences for Club Activity */}
              {selectedExperience === "club" && (
                <motion.div
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    {Object.values(subExperiences).map((subExp, index) => (
                      <motion.div
                        key={subExp.id}
